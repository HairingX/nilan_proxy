...
class CTS602WithNoQuirksTest(modelTester):    
    ...
    def test_quirks_not_loaded(self):
        self.assertNotIn(GenvexNabtoDatapointKey.TEMP_HOTWATER_TOP, self.loadedModel.datapoints)
...
class CTS602WithQuirksTest(modelTester):    
    ...
    def test_hotwater_temp_quirk_loaded(self):
        self.assertIn(GenvexNabtoDatapointKey.TEMP_HOTWATER_TOP, self.loadedModel.datapoints)
