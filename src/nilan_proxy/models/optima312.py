...
class NilanProxyOptima312(NilanProxyBaseModel):
    def __init__(self, device_number:int, slave_device_number:int, slave_device_model:int):
        ...
        self.setpoints = {
            ...
            NilanProxySetpointKey.REHEAT_ENABLE: NilanProxySetpoint(read_address=21, write_address=21, divider=1, min=0, max=1, signed=False),
            NilanProxySetpointKey.TEMP_HOTWATER: NilanProxySetpoint(read_address=1, write_address=1, divider=10, min=0, max=550, signed=True),
