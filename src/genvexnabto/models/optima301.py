...
class GenvexNabtoOptima301(GenvexNabtoBaseModel):
    def __init__(self):
        ...
        self._setpoints = {
            GenvexNabtoSetpointKey.COOLING_ENABLE: GenvexNabtoSetpoint(read_obj=0, read_address=2, write_obj=0, write_address=2, divider=1, offset=0, min=0, max=1, signed=False),
            ...
            GenvexNabtoSetpointKey.PREHEAT_ENABLE: GenvexNabtoSetpoint(read_obj=0, read_address=20, write_obj=0, write_address=20, divider=1, offset=0, min=0, max=1, signed=False),         
            GenvexNabtoSetpointKey.TEMP_COOLING_START_OFFSET: GenvexNabtoSetpoint(read_obj=0, read_address=1, write_obj=0, write_address=1, divider=10, offset=0, min=30, max=100, signed=True),
