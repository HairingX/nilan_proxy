...
class GenvexNabtoOptima270(GenvexNabtoBaseModel):
    def __init__(self):
        ...
        self._datapoints = {
            GenvexNabtoDatapointKey.ALARM_BITS: GenvexNabtoDatapoint(obj=0, address=38, divider=1, offset=0, signed=False),        
            GenvexNabtoDatapointKey.BYPASS_ACTIVE: GenvexNabtoDatapoint(obj=0, address=53, divider=1, offset=0, signed=False),
            ...
            GenvexNabtoDatapointKey.TEMP_EXTRACT: GenvexNabtoDatapoint(obj=0, address=23, divider=10, offset=-300, signed=True),
            ...
            # GenvexNabtoDatapointKey.REHEAT_PWM: GenvexNabtoDatapoint(obj=0, address=41, divider=100, offset=0, signed=False),
            # GenvexNabtoDatapointKey.REHEAT_PWM: GenvexNabtoDatapoint(obj=0, address=42, divider=100, offset=0, signed=False),
        }
        ...
        self._setpoints = {
            ...
            GenvexNabtoSetpointKey.TEMP_BYPASS_OPEN_OFFSET: GenvexNabtoSetpoint(read_obj=0, read_address=21, write_obj=0, write_address=52, divider=10, offset=0, min=10, max=100, signed=True),
