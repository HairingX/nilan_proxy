...
class GenvexNabtoOptima312(GenvexNabtoBaseModel):
    def __init__(self, device_number:int, slave_device_number:int, slave_device_model:int):
        ...
        self._attr_model_name="Optima 312"
        ...
        self.setpoints = {
            ...
            GenvexNabtoSetpointKey.REHEAT_ENABLE: GenvexNabtoSetpoint(read_address=21, write_address=21, divider=1, min=0, max=1, signed=False),
            GenvexNabtoSetpointKey.TEMP_HOTWATER: GenvexNabtoSetpoint(read_address=1, write_address=1, divider=10, min=0, max=550, signed=True),
