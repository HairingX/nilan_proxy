...
class GenvexNabtoOptima314(GenvexNabtoBaseModel):
    def __init__(self, device_number:int, slave_device_number:int, slave_device_model:int):
        ...
        self.datapoints = {
            GenvexNabtoDatapointKey.BYPASS_ACTIVE: GenvexNabtoDatapoint(read_address=12, divider=1, signed=False),
            ...
            GenvexNabtoDatapointKey.TEMP_EXTRACT: GenvexNabtoDatapoint(read_address=64, divider=10, offset=-300, signed=True),
        ...
        self.setpoints = {
            ...
            GenvexNabtoSetpointKey.TEMP_HOTWATER: GenvexNabtoSetpoint(read_address=122, write_address=254, divider=10, min=0, max=550, signed=True),
