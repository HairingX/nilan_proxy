...
class GenvexNabtoOptima251(GenvexNabtoBaseModel):
    def __init__(self, device_number:int, slave_device_number:int, slave_device_model:int):
        ...
        self._attr_model_name="Optima 251"
        ...
        self.setpoints = {
            ...
            GenvexNabtoSetpointKey.FILTER_REPLACE_INTERVAL: GenvexNabtoSetpoint(read_address=4, write_address=4, divider=1, min=0, max=6, signed=False),    
            ...
            GenvexNabtoSetpointKey.REHEAT_ENABLE: GenvexNabtoSetpoint(read_address=2, write_address=2, divider=1, min=0, max=1, signed=False),
            GenvexNabtoSetpointKey.TEMP_BYPASS_OPEN_OFFSET: GenvexNabtoSetpoint(read_address=17, write_address=17, divider=10, min=10, max=100, signed=True),
